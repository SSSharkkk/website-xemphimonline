...
@foreach ($edit as $item=>$edit)
 ...
 <form action="{{route('category.update',$edit->id)}}" id="form" method="POST" > 
  @csrf
  @method('put')
    <!-- diary -->
    {{-- <div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" value="{{$edit->category_name}}" data-validation="length" data-validation-length="min3" data-validation-error-msg="vui lòng nhập tên danh mục" class="form-control" id="category_name" name="category_name" onkeyup="ChangeToSlug()">
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" value="{{$edit->category_slug}}"  data-validation="length" data-validation-length="min3" data-validation-error-msg="vui lòng nhập tên danh mục" class="form-control" id="category_slug" name="category_slug">
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" value="{{$edit->category_desc}}"  data-validation="length" data-validation-length="min3" data-validation-error-msg="Vui lòng nhập mô tả danh mục" class="form-control" id="category_desc" name="category_desc">
      </div>
    </div>
