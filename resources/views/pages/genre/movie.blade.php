...
@extends('welcome')
        ...
        <!-- page title -->
        <section class="section section--first section--bg" data-bg="{{asset('front-end/image/section.jpg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section__wrap">
                            <!-- section title -->
                            <h2 class="section__title">{{$genre->genre_name}}</h2>
                            <!-- end section title -->
    
                            <!-- breadcrumb -->
                            <ul class="breadcrumb" style="background-color: #2b2b31;">
                                <li class="breadcrumb__item"><a href="{{URL::to('/trang-chu')}}">Trang Chủ</a></li>
                                <li class="breadcrumb__item breadcrumb__item--active">{{$genre->genre_name}}</li>
                            </ul>
                            <!-- end breadcrumb -->
                        </div>
                    </div>
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card" style="background-color: #2b2b31;">
						<div class="card__cover">
							<img src="{{asset('public/images/uploads/'.$item->movie_images)}}" height="250" alt="">
