...
<h4 class="link-success">Thêm Năm</h4>
 ...
 <form action="{{route('time.store')}}" id="form" method="POST" > 
  {{ csrf_field() }}
    <!-- diary -->
    {{-- <div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" data-validation="number" data-validation-length="min3" data-validation-error-msg="vui lòng nhập tên Năm" class="form-control" id="times_name" name="times_name" onkeyup="ChangeToSlug()">
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" data-validation="number" data-validation-length="min3" data-validation-error-msg="vui lòng nhập tên Năm" class="form-control" id="times_slug" name="times_slug">
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" data-validation="length" data-validation-length="min3" data-validation-error-msg="Vui lòng nhập mô tả Năm" class="form-control" id="times_desc" name="times_desc">
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <select class="form-select"  aria-label="Default select example" id="times_status" name="times_status">
