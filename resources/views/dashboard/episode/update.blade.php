...
@foreach ($edit as $item=>$edit)
 ...
 <form action="{{URL::to('/update-eps/'.$edit->id)}}" id="form" method="POST" > 
  ...
  {{ csrf_field() }}
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" value="{{$edit->film}}" data-validation="length" data-validation-length="min3" data-validation-error-msg="Vui lòng nhập mô tả Tập Phim" class="form-control" id="category_desc" name="film">
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" value="{{$edit->episode}}" data-validation="length" data-validation-length="min3" data-validation-error-msg="Vui lòng nhập mô tả Tập Phim" class="form-control" id="category_desc" name="episode">
      </div>
    </div>
