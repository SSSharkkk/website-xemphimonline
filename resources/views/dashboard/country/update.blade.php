...
@foreach ($edit as $item=>$edit)
 ...
 <form action="{{route('country.update',$edit->id)}}" id="form" method="POST" > 
  @csrf
  @method('put')
    <!-- diary -->
    {{-- <div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" value="{{$edit->country_name}}" data-validation="length" data-validation-length="min3" data-validation-error-msg="vui lòng nhập tên Quốc Gia" class="form-control" id="country_name" name="country_name" onkeyup="ChangeToSlug()">
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" value="{{$edit->country_slug}}"  data-validation="length" data-validation-length="min3" data-validation-error-msg="vui lòng nhập tên Quốc Gia" class="form-control" id="country_slug" name="country_slug">
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" value="{{$edit->country_desc}}"  data-validation="length" data-validation-length="min3" data-validation-error-msg="Vui lòng nhập mô tả Quốc Gia" class="form-control" id="country_desc" name="country_desc">
      </div>
    </div>
