                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section__wrap">
                            <!-- section title -->
                            <h2 class="section__title">{{$country->country_name}}</h2>
                            <!-- end section title -->
    
                            <!-- breadcrumb -->
                            <ul class="breadcrumb" style="background-color: #2b2b31;">
                                <li class="breadcrumb__item"><a href="{{URL::to('/trang-chu')}}">Trang Chủ</a></li>
                                <li class="breadcrumb__item breadcrumb__item--active">{{$country->country_name}}</li>
                            </ul>
                            <!-- end breadcrumb -->
                        </div>
                    </div>
...
<ion-icon name="play-outline"></ion-icon>							</a>
						...
						<div class="card__content">
							<h3 class="card__title"><a href="{{URL::to('/phim/'.$item->movie_slug)}}">{{$item->movie_name}}</a></h3>
							<span class="card__category">
								<a href="#">{{$country->country_name}}</a>
							</span>
							<span class="card__rate"><ion-icon style="margin-right: 5px; margin-left:5px;" name="star-outline"></ion-icon>8.4</span>
